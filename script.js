...
function startGame() {
    ...
    //   document.querySelector("#game_elements").classList.add("in_out1");
    ...
    /*
    document.querySelector(".type1").addEventListener("click", clickBaby);
    document.querySelector(".type2").addEventListener("click", clickDiamant);
    document.querySelector(".type3").addEventListener("click", clickHest);*/
...
function clickFigur() {
    ...
    // find ud af hvilken type der er blevet klikket på
    ...
    //    document.querySelector("#game_elements").classList = "type1 position" + myNumber;

    //this.classList = "type1 position" + myNumber;

    /* let myNumberny = Math.floor((Math.random() * 3) + 1);
     console.log("tilfældigttal " + myNumberny);

     this.classList = "position1 type" + myNumberny;*/
